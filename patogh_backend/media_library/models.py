...
class PdfItem(models.Model):
    ...
    cover_image = models.FileField('عکس جلد', upload_to='pdf_covers/', blank=True, default='')
    file = models.FileField('فایل PDF', upload_to='pdfs/')
...
class Podcast(models.Model):
    ...
    cover_image = models.FileField('عکس جلد', upload_to='podcast_covers/', blank=True, default='')
    published = models.BooleanField('منتشر شده', default=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class PodcastEpisode(models.Model):
    ...
    audio_file = models.FileField('فایل صوتی', upload_to='podcasts/')
    created_at = models.DateTimeField(auto_now_add=True)
